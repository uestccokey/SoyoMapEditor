...
public class NewMapDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        mapTypeComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "正视角" }));
        ...
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jToolBar1, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(mapWidthTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 72, Short.MAX_VALUE))
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(mapHeightTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE))))))
...
//        PreviewRenderFactory.createPreviewRender(map);//新建地图时，暂时不创建PreviewRender对象，在需要时在创建，节省内存
        ...
        tLayer.setName("瓷砖层0");
//        ObjectLayer sLayer = new ObjectLayer(map, mapW, mapH);
...
//        map.addLayer(sLayer);
        for (int i = 0; i < mapPropertyTable.getRowCount(); i++) {
            map.addProperty(mapPropertyTable.getModel().getValueAt(i, 0).toString(), mapPropertyTable.getModel().getValueAt(i, 1).toString());
        }
